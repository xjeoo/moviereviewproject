...
const LoginPage = () => {
  ...
  return (
    <div className="w-dvw h-full">
      <div className="flex flex-col items-center px-12 py-20 bg-indigo-800 w-max mx-auto mt-40 rounded-2xl">
        ...
        <div className="flex flex-col items-center">
          <button
            className="text-2xl text-[#e0e0e0] px-4 py-2 bg-orange-400 rounded-3xl mt-3 hover:bg-[#e89906] cursor-pointer"
